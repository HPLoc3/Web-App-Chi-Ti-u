...
// ==========================================
// DEFAULT MOCK DATA (High quality fallback)
// ==========================================
...
export const FinancialOverview: React.FC<FinancialOverviewProps> = ({
  ...
  // Calculate percentages & total expense for donut chart center label
  ...
  return (
    <div className={`space-y-6 text-slate-800 dark:text-slate-100 ${className}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* 2. DONUT / PIE CHART: TỶ LỆ CHI TIÊU THEO DANH MỤC */}
        ...
        {/* 3. BAR CHART: SO SÁNH THU VS CHI QUA CÁC THÁNG */}
      ...
      {/* ---------------------------------------------------- */}
      {/* 4. RECENT TRANSACTIONS TABLE (5 ITEMS) */}
      {/* ---------------------------------------------------- */}
